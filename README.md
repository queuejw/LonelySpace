...
>
> В данный момент разработка новых функций приостановлена, поскольку мы готовим большое техническое обновление для
> поддержки инновационных эффектов и систем на базе GNU/Linux
...
- [Создание своих планет](github/database/CREATING_PLANETS.md#создание-планет)
