...
Если возникнут трудности с запуском игры, обратитесь
к [руководству по устранению неполадок](database/GAME-TROUBLESHOOTING.md#устранение-неполадок)
...
Базовые функции реализованы. Мы регулярно исправляем и улучшаем уже существующие, а также иногда добавляем новые.
...
-
    -
        - [x] Изменение параметров (прочность, здоровье экипажа т.д.)
-
    - [x] Взаимодействие с кораблём
-
    -
...
Игра содержит звуки, загруженные с сайта Zvukipro.com

Музыка в игре: Пока что её нет. =)
