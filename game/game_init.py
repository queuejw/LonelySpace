...
def init_survival_game():
    clear_terminal()
    slow_print_colored_text("Идёт загрузка...", 0.2)
    print_colored_text("> Генерация космического пространства ...")
    # Создание локации
    m_planets = create_planets(20)  # Генерируем планеты
    game_main.UNIVERSE = create_universe(m_planets)  # Создаем вселенную с этими планетами.
    ...
    # Создание игрока
    game_main.PLAYER = create_player()
